...
<html>
    ...
    <head>
        ...
        <title>Forgot Password? | UST Online Advising System</title>
            ...
            <div class="container-fluid" style="padding-right:90px;padding-left:90px;">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <h3 class="text-nowrap" style="color:#d14041;">Forgotten password?</h3>
                    </div>
                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                        <p class="help-block" style="color:rgb(0,0,0);">Enter your official universityaccount email address in the field below. A confirmation will be sent to ensure the validation of this request. The email will contain the instructions on how to reset your password.</p>
                        <form>
                            <div class="form-group"><label class="control-label">Email: </label><input class="form-control" type="password" required="" placeholder="juan.delacruz.engg@ust.edu.ph">
